...
$(document).ready(function () {
    ...
    $("#addTaiKhoan").click(function () {
        $.ajax({
            type: "post",
            url: 'http://ec2-18-218-15-7.us-east-2.compute.amazonaws.com:8088/tai-khoan-thu-chi/add',
...
function deleteTaiKhoan(tk) {
    ...
    if (r == true) {
        $.ajax({
            type: 'DELETE',
            url: 'http://ec2-18-218-15-7.us-east-2.compute.amazonaws.com:8088/tai-khoan-thu-chi/remove/' + user.toString() + '/' + tk.toString(),
            success: function (data) {
                // alert("Đã xóa!");
                location.reload();
            },
